...
<div>
  {/* Features Section */}
        <section className="mt-10 mb-24 bg-white/30 rounded-2xl px-4 py-20 backdrop-blur dark:bg-gray-900/90 sm:px-6 lg:px-10">
          ...
          <dl className="mt-12 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div key={feature.title} className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="h-6 w-6 flex-shrink-0 text-lime-600 dark:text-lime-400">
